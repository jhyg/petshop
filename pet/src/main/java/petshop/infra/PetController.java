...
import javax.transaction.Transactional;
 ...
 public class PetController {
        ...
        @RequestMapping(value = "/{id}/test555",
                method = RequestMethod.PUT,
                produces = "application/json;charset=UTF-8")
        public Pet test555(@PathVariable(value = "id") Long id, HttpServletRequest request, HttpServletResponse response)
                throws Exception {
                        System.out.println("##### /pet/test555  called #####");
                        Optional<Pet> optionalPet = petRepository.findById(id);
